...
var Receipt = function () {
    ...
    let initialComponents = () => {
        ...
        $('[name="btnCreate"]').click(function (e) {
            ...
            editingDataRow = null;
            modal_header_text.text("Thêm một phiếu thu");
                ...
                validator.validate().then(function (e) {
                    "Valid" == e ?
                        (
                            ...
                            console.log(data),
                            App.sendDataToURL("/Receipt/Save", data, "POST")
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/Receipt/DataTableGetList";
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/Receipt/DeleteByIds", dtTable, null)
        .then(function () {
            dtTable.draw();
            App.showHideButtonDelete(false);
        });
