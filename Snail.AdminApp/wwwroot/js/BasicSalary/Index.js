...
var BasicSalary = function () {
                ...
                validator.validate().then(function (e) {
                    "Valid" == e ?
                        (
                            ...
                            modal_form.find("select, textarea, input").each((index, el) => {
                                ...
                                if (fieldName) {
                                    ...
                                    switch (fieldName) {
                                        ...
                                        default:
                                            obj[$(el).data("field")] = (isVNDFormat ? $(el).autoNumeric('get') : $(el).val());
                                    }
                                }
                            }),
                            data = {
                            ...
                            App.sendDataToURL("/BasicSalary/Save", data, "POST")
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/BasicSalary/DataTableGetList";
        ...
        datatableOption.columns = [
            ...
            { "data": "value", "name": "value", "autoWidth": true, "title": "Số tiền" },
        ...
        $('#dtTable tbody').on('click', 'a.edit', function (e) {
            ...
            //$('input[data-field="Value"]').val(editingDataRow.value);
            $('input[data-field="Value"]').autoNumeric('set', editingDataRow.value);
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/BasicSalary/DeleteByIds", dtTable, null)
        .then(function () {
            dtTable.draw();
            App.showHideButtonDelete(false);
        });
