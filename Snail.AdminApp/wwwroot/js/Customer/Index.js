...
var Customer = function () {
    ...
    let initialComponents = () => {
        ...
        $('[name="btnCreate"]').click(function (e) {
            e.preventDefault();
            window.location.href = "/Customer/SecurityEdit";
        });
        ...
        $('#fileImportData').change(function () {
            ...
            var url = "/Customer/ImportDataFromExcelFile";
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/Customer/DataTableGetList";
        ...
        datatableOption.columns = [
            ...
            { "data": "code", "name": "code", "autoWidth": true, "title": "Mã KH" },
            {
                "data": "fullName", "name": "fullName", width: "220px", "title": "Khách hàng",
                "render": function (data, type, full, meta) {
                    ...
                    html += '<a class="menu-link px-3" href="#!"><i class="las la-birthday-cake"></i> ' + full.strDob + '</a><br/>';
        ...
        $('#dtTable tbody').on('click', 'a.edit', function (e) {
            ...
            if (selectedDataRow != null) {
                window.location.href = "/Customer/SecurityEdit?id=" + selectedDataRow.id;
            }
        });
    ...
    function deleteDataRows(dataRows) {
        console.log(dataRows.map((item) => item.id));
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/Customer/DeleteByIds", dtTable, null)
            .then(function () {
                dtTable.draw();
                App.showHideButtonDelete(false);
            });
