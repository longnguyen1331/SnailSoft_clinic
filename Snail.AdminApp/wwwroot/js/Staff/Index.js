...
var Staff = function () {
    ...
    let initialComponents = () => {
        ...
        $('[name="btnCreate"]').click(function (e) {
            ...
            window.location.href = "/Staff/SecurityEdit";
        });
    ...
    let initialDatatable = function () {
        ...
        datatableOption.columns = [
            ...
            {
                "data": "id_Image_FullName_Email", "name": "image_FullName_Email", "autoWidth": true, "title": "Người sử dụng",
                "render": function (data, type, full, meta) {
                    let tempArr = data.split("|");
                    return '<div class="d-flex align-items-left">\
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">\
                                    <a href="/Staff/SecurityEdit?id=' + tempArr[0] + '">\
                                        <div class="symbol-label">\
                                            <img src="' + tempArr[1] + '" alt="Emma Smith" class="w-100">\
                                        </div>\
                                    </a>\
                                </div>\
                                <div class="d-flex flex-column">\
                                    <a href="/Staff/SecurityEdit?id=' + tempArr[0] + '" class="text-gray-800 text-hover-primary mb-1">' + tempArr[2] + '</a>\
                                    <span>' + tempArr[3] + '</span>\
                                </div>\
                            </div>';
                }
            },
            { "data": "userName", "name": "userName", "autoWidth": true, "title": "Tên truy cập" },
            {
                "data": "strCreatedDate", "name": "strCreatedDate", "autoWidth": true, "title": "Ngày tạo", "render": function (data, type, full, meta) {
                    return '<span class="text-muted">' + data + '</span>';
                }
            },
            {
                "data": "appRoles", "name": "appRoles", "autoWidth": true, "title": "Phân quyền",
                "render": function (data, type, full, meta) {
