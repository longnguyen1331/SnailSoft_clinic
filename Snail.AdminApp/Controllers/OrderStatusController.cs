...
namespace Snail.AdminApp.Controllers
{
    ...
    {
        private readonly IOrderStatusApiClient _orderStatusApiClient;
        public OrderStatusController(IOrderStatusApiClient orderStatusApiClient)
        {
            _orderStatusApiClient = orderStatusApiClient;
        }
        ...
        public IActionResult Index()
        {
            ...
            model.PageTitle = "Trạng thái đơn hàng";
            model.Breadcrumbs = new List<string>() { "Cài đặt", "Danh mục hệ thống", "Trạng thái", "Trạng thái đơn hàng" };
        ...
        public async Task<IActionResult> DataTableGetList(int? draw, int? start, int? length, string textSearch)
        {
            ...
            var request = new ManageOrderStatusPagingRequest()
            {
            ...
            var orderStatusApiClient = await _orderStatusApiClient.GetManageListPaging(request);

            return Json(new
            {
                draw = draw,
                recordsFiltered = orderStatusApiClient.TotalRecords,
                recordsTotal = orderStatusApiClient.TotalRecords,
                data = orderStatusApiClient.Items
            });
        }
        ...
        public async Task<IActionResult> DeleteByIds([FromBody] DeleteRequest request)
        {
            ...
            var result = await _orderStatusApiClient.DeleteByIds(request);
        ...
        [HttpPost]
        public async Task<IActionResult> Save([FromBody] AddEditRequest<OrderStatusRequest> rq)
        {
            ...
            if (rq != null)
            {
                ...
                result = await _orderStatusApiClient.AddOrUpdateAsync(rq.Data);
            }
            else
            {
