...
namespace Snail.AdminApp.Controllers
{
    ...
    {
        private readonly IAttributeApiClient _customerTypeApiClient;
        public AttributeController(IAttributeApiClient customerTypeApiClient)
        {
        ...
        public IActionResult Index()
        {
            ...
            model.PageTitle = "Thuộc tính";
            model.Breadcrumbs = new List<string>() { "Danh mục", "Thuộc tính" };
        ...
        public async Task<IActionResult> DataTableGetList(int? draw, int? start, int? length, string textSearch)
        {
            ...
            var request = new ManageAttributePagingRequest()
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Save([FromBody] AddEditRequest<AttributeRequest> rq)
        {
            ...
            if (data != null)
            {
                ...
                if (data.Items.Count() > 0)
                {
                    foreach (var item in data.Items)
                    {
                        ...
                        {
                            propertyInfo = typeof(AttributeDto).GetProperty(exportedField.Code);
