...
var Payroll = function () {
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/Payroll/DataTableGetList";
        ...
        datatableOption.columns = [
            ...
            { "data": "strFromDate", "strFromDate": "name", "autoWidth": true, "title": "Ngày bắt đầu" },
            { "data": "strToDate", "name": "strToDate", "autoWidth": true, "title": "Ngày kết thúc" },
            {
        ...
        $('#dtTable tbody').on('click', 'a.edit', function (e) {
            ...
            if (selectedDataRow) {
                window.location.href = "/Payroll/Edit?id=" + selectedDataRow.id;
            }
        });
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/Payroll/DeleteByIds", dtTable, null)
        .then(function () {
            dtTable.draw();
            App.showHideButtonDelete(false);
        });
