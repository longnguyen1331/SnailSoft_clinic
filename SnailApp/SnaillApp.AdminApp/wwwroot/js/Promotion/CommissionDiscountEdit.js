...
var Promotion = function () {
                ...
                validator.validate().then(function (e) {
                    "Valid" == e ?
                        (
                            ...
                            App.sendDataToURL("/Promotion_CommissionDiscount/Save", data, "POST")
    ...
    let initialDatatableCommissionDiscount = function () {
        ...
        datatableOption.ajax.url = "/Promotion_CommissionDiscount/DataTableGetList";
    ...
    function deleteCommissionDiscountDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/Promotion_CommissionDiscount/DeleteByIds", dtTableCommissionDiscount, null)
            .then(function () {
                dtTableCommissionDiscount.draw();
                App.showHideButtonDelete(false);
            });
