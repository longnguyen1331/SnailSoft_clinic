...
var Testimonial = function () {
    ...
    let initialComponents = () => {
        ...
        $("#filterByTestimonialTypeId").change(function () {
            dtTable.draw();
        });
    };
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/Testimonial/DataTableGetList";
        ...
        $('#dtTable tbody').on('click', 'a.edit', function (e) {
            ...
            if (selectedDataRow != null) {
                window.location.href = "/Testimonial/Edit?id=" + selectedDataRow.id;
            }
        });
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/Testimonial/DeleteByIds", dtTable, null)
            .then(function () {
                dtTable.draw();
                App.showHideButtonDelete(false);
            });
