...
var Newsletter = function () {
    ...
    let initialComponents = () => {
        ...
        $('#kt_modal_edit_submit').click(function (e) {
                ...
                validator.validate().then(function (e) {
                    "Valid" == e ?
                        (
                            ...
                            App.sendDataToURL("/Newsletter/Save", data, "POST")
            ...
            $('input[name="kt_modal_edit_form_email"]').focus();
        });
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/Newsletter/DataTableGetList";
        ...
        $('#dtTable tbody').on('click', 'a.edit', function (e) {
            ...
            setTimeout(function () { $('input[name="kt_modal_edit_form_email"]').focus() }, 500);
            modal.modal('show');
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/Newsletter/DeleteByIds", dtTable, null)
        .then(function () {
            dtTable.draw();
            App.showHideButtonDelete(false);
        });
