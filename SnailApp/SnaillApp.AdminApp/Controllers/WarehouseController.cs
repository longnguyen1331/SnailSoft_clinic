...
namespace SnailApp.AdminApp.Controllers
{
    ...
    {
        private readonly IReportWarehouseApiClient _reportWarehouseApiClient;

        public WarehouseController(
            IReportWarehouseApiClient reportWarehouseApiClient
        )
        {
            _reportWarehouseApiClient = reportWarehouseApiClient;
        }
        ...
        public IActionResult Index()
        {
            ...
            model.PageTitle = "Kho hàng";
            model.Breadcrumbs = new List<string>() { "Hàng hóa & dịch vụ", "Kho hàng" };
        ...
        public async Task<IActionResult> DataTableGetList(int? draw, int? start, int? length, string tDate)
        {
            ...
            var orderApiClient = await _reportWarehouseApiClient.GetReport(request);
        ...
        public async Task<FileResult> ExportToExcel()
        {
            ...
            var data = await _reportWarehouseApiClient.GetReport(request);
