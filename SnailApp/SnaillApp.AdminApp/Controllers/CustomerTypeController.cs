...
namespace SnailApp.AdminApp.Controllers
{
    ...
    {
        private readonly ICustomerTypeApiClient _customerTypeApiClient;
        public CustomerTypeController(ICustomerTypeApiClient customerTypeApiClient)
        {
        ...
        public IActionResult Index()
        {
            ...
            model.PageTitle = "Nhóm khách hàng";
            model.Breadcrumbs = new List<string>() { "Khách hàng", "Nhóm khách hàng" };
        ...
        public async Task<IActionResult> DataTableGetList(int? draw, int? start, int? length, string textSearch)
        {
            ...
            var request = new ManageCustomerTypePagingRequest()
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Save([FromBody] AddEditRequest<CustomerTypeRequest> rq)
        {
            ...
            if (data != null)
            {
                ...
                if (data.Items.Count() > 0)
                {
                    foreach (var item in data.Items)
                    {
                        ...
                        {
                            propertyInfo = typeof(CustomerTypeDto).GetProperty(exportedField.Code);
