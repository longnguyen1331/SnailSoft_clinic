...
namespace SnailApp.AdminApp.Controllers
{
    public class PatientController : BaseController
    {
        ...
        public PatientController(IUserApiClient userApiClient, IAppRoleApiClient appRoleApiClient,
        ...
        public async Task<IActionResult> Index()
        {
            ...
            model.Breadcrumbs = new List<string>(){ "Patient" };
        ...
        public async Task<IActionResult> DataTableGetList(int? draw, int? start, int? length, string textSearch)
        {
            ...
            {
                Type = (int)ViewModels.Enums.RoleType.PatientRole,
        ...
        public async Task<IActionResult> SaveProfileDetail([FromForm] UserRequest rq)
        {
            ...
            if (rq != null)
            {
                rq.Type = (int)ViewModels.Enums.RoleType.PatientRole;
