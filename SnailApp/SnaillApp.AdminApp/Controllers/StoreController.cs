...
namespace SnailApp.AdminApp.Controllers
{
    public class StoreController : BaseController
    {
        ...
        public StoreController(IStoreApiClient storeApiClient, IStoreStatusApiClient storeStatusApiClient,
        ...
        public IActionResult Index()
        {
            ...
            model.PageTitle = "Cửa hàng";
            model.Breadcrumbs = new List<string>() { "Cài đặt", "Cửa hàng" };
        ...
        public async Task<IActionResult> DataTableGetList(int? draw, int? start, int? length, string textSearch)
        {
            ...
            var request = new ManageStorePagingRequest()
            {
            ...
            var storeApiClient = await _storeApiClient.GetManageListPaging(request);

            return Json(new
            {
                draw = draw,
                recordsFiltered = storeApiClient.TotalRecords,
                recordsTotal = storeApiClient.TotalRecords,
                data = storeApiClient.Items
            });
        }
        ...
        public async Task<IActionResult> DeleteByIds([FromBody] DeleteRequest request)
        {
            ...
            var result = await _storeApiClient.DeleteByIds(request);
        ...
        [HttpPost]
        public async Task<IActionResult> Save([FromBody] AddEditRequest<StoreRequest> rq)
        {
            ...
            if (rq != null)
            {
                ...
                result = await _storeApiClient.AddOrUpdateAsync(rq.Data);
            }
            else
            {
        ...
        public async Task<FileResult> ExportToExcel()
        {
            ...
            var data = await _storeApiClient.GetManageListPaging(request);
            ...
            if (data != null)
            {
                ...
                if (data.Items.Count() > 0)
                {
                    foreach (var item in data.Items)
                    {
                        ...
                        {
                            propertyInfo = typeof(StoreDto).GetProperty(exportedField.Code);
