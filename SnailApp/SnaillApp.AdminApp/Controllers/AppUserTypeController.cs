...
namespace SnailApp.AdminApp.Controllers
{
    ...
    {
        private readonly IAppUserTypeApiClient _appUserTypeApiClient;
        public AppUserTypeController(IAppUserTypeApiClient appUserTypeApiClient)
        {
            _appUserTypeApiClient = appUserTypeApiClient;
        }

        public IActionResult Index()
        {
            var model = new AppUserTypeViewModel();
        ...
        public async Task<IActionResult> DataTableGetList(int? draw, int? start, int? length, string textSearch)
        {
            ...
            var request = new ManageAppUserTypePagingRequest()
            {
            ...
            var appUserTypeApiClient = await _appUserTypeApiClient.GetManageListPaging(request);

            return Json(new
            {
                draw = draw,
                recordsFiltered = appUserTypeApiClient.TotalRecords,
                recordsTotal = appUserTypeApiClient.TotalRecords,
                data = appUserTypeApiClient.Items
            });
        }
        ...
        public async Task<IActionResult> DeleteByIds([FromBody] DeleteRequest request)
        {
            ...
            var result = await _appUserTypeApiClient.DeleteByIds(request);
        ...
        [HttpPost]
        public async Task<IActionResult> Save([FromBody] AddEditRequest<AppUserTypeRequest> rq)
        {
            ...
            if (rq != null)
            {
                ...
                result = await _appUserTypeApiClient.AddOrUpdateAsync(rq.Data);
            }
            else
            {
        ...
        public async Task<IActionResult> Filter(string textSearch)
        {
            ...
            var data = await _appUserTypeApiClient.GetManageListPaging(request);
            return Ok(data);
        }
    }
}
