...
namespace ChinoPet.Website.Controllers.Components
{
    public class FooterViewComponent: ViewComponent
    {
        ...
        public FooterViewComponent(IWebsiteUIApiClient websiteUIApiClient, IConfiguration configuration)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var websiteUIApiClient = await _websiteUIApiClient.GetFooterObjects(new WebsiteUIRequest()
            {
